...
import { Box, Loader2, AlertCircle, Building2, ArrowRight, Check } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  const handleTenantSubmit = async (e) => {
    ...
    try {
      ...
      await createTenant(companyName, slug + '-' + Date.now().toString().slice(-4));
      navigate('/panel', { replace: true });
    } catch (err) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          {step === 'account' ? (
            <>
              ...
              <p className="text-gray-500 text-sm mb-6">14 gün ücretsiz deneyin</p>
